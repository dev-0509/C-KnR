...
/*
	...
	Reads the expression to be evaluated from the command line, each operator/operand
	as a seperate cmd arguement, and the entire expression is a space seperated 
	expression.
